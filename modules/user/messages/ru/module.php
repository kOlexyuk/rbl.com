...
return [
    ...
    'BUTTON_UPDATE_PROFILE'=>'Редактировать профиль',
    ...
    'FLASH_EMAIL_CONFIRM_REQUEST' => 'Подтвердите ваш Email/Тлф.',
    'FLASH_EMAIL_CONFIRM_SUCCESS' => 'Спасибо! Ваш Email/Тлф успешно подтверждён.',
    'FLASH_EMAIL_CONFIRM_ERROR' => 'Ошибка подтверждения Email/Тлф .',

    'FLASH_PASSWORD_RESET_REQUEST' => 'Спасибо! На ваш Email/Тлф было отправлено письмо со ссылкой на восстановление пароля.',
    ...
    'ERROR_PHONE_EXISTS' => 'Этот ТЛФ уже используется.',
    ...
    'CONFIRM_PHONE' => 'Подтвердите номер тлф.'
];