...
//            $deleted_service = explode(',', trim($this->deleted_service_ids, ','));
//            $added_service = explode(',', trim($this->added_service_ids,','));
//
//            $deleted_region = explode(',', trim($this->deleted_region_ids, ','));
//            $added_region = explode(',', trim($this->added_region_ids,','));


//            UserService::deleteAll([
//                'AND',
//                ['in', 'service_id',  $deleted_service],
//            ]);
